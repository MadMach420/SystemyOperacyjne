...
void resize_buffer_struct(BufferStruct* buffer_struct) {
    buffer_struct->max_size *= 2;
    buffer_struct->buffers = realloc(buffer_struct->buffers, buffer_struct->max_size * sizeof (char*));
}
...
void wc_file_to_buffer_struct(BufferStruct* buffer_struct, char* filename) {
    ...
    if (buffer_struct->current_size == buffer_struct->max_size) resize_buffer_struct(buffer_struct);
